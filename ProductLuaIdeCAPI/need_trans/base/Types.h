...
#define V3F_C4F_T2F_SIZE sizeof(NS_MEDIA::V3F_C4F_T2F)
#define Vertex3F_OFFSET offsetof(NS_MEDIA::V3F_C4F_T2F, vertices)
#define Color4F_OFFSET offsetof(NS_MEDIA::V3F_C4F_T2F, colors)
#define Tex2F_OFFSET offsetof(NS_MEDIA::V3F_C4F_T2F, texCoords)
