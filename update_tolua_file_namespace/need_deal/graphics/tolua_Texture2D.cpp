...
static int tolua_Texture2D_media_Texture2D_load03(lua_State* tolua_S)
{
 ...
 if (
     !tolua_isusertype(tolua_S,1,"media::Texture2D",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"const Image",0,&tolua_err) ||
     (tolua_isvaluenil(tolua_S,3,&tolua_err) || !tolua_isusertype(tolua_S,3,"const NS_MEDIA::Size",0,&tolua_err)) ||
     !tolua_isnoobj(tolua_S,4,&tolua_err)
 )
  goto tolua_lerror;
 else
...
#endif
 {
...
#endif
  {
   FileHandle* tolua_ret = (FileHandle*)  self->getFileHandle();
    tolua_pushusertype(tolua_S,(void*)tolua_ret,"FileHandle");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
TOLUA_API int tolua_Texture2D_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"media");
   #ifdef __cplusplus
   tolua_cclass(tolua_S,"Texture2D","media::Texture2D","Texture",tolua_collect_media__Texture2D);
   #else
   tolua_cclass(tolua_S,"Texture2D","media::Texture2D","Texture",NULL);
   #endif
