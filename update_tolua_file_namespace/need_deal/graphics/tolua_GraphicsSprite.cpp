...
static void tolua_reg_types (lua_State* tolua_S)
{
 ...
 tolua_usertype(tolua_S,"GLES20Shader");
 tolua_usertype(tolua_S,"FileHandle");
 tolua_usertype(tolua_S,"std::list<GLES20Shader*>");
 tolua_usertype(tolua_S,"Texture2D");
 tolua_usertype(tolua_S,"NS_MEDIA::Size");
 tolua_usertype(tolua_S,"media::GraphicsSprite");
 tolua_usertype(tolua_S,"NS_MEDIA::Rect");
 tolua_usertype(tolua_S,"V3F_C4F_T2F_Quad");
}
...
static int tolua_GraphicsSprite_media_GraphicsSprite_setShader00(lua_State* tolua_S)
{
 ...
 if (
     !tolua_isusertype(tolua_S,1,"media::GraphicsSprite",0,&tolua_err) ||
     !tolua_isusertype(tolua_S,2,"GLES20Shader",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
 else
...
#endif
 {
...
#endif
  {
   GLES20Shader* tolua_ret = (GLES20Shader*)  self->getShader();
    tolua_pushusertype(tolua_S,(void*)tolua_ret,"GLES20Shader");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
#endif
 {
...
#endif
  {
   const std::list<GLES20Shader*>& tolua_ret = (const std::list<GLES20Shader*>&)  self->getAnimationShaders();
    tolua_pushusertype(tolua_S,(void*)&tolua_ret,"const std::list<GLES20Shader*>");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
#endif
 {
...
#endif
  {
   const V3F_C4F_T2F_Quad* tolua_ret = (const V3F_C4F_T2F_Quad*)  self->getQuads();
    tolua_pushusertype(tolua_S,(void*)tolua_ret,"const V3F_C4F_T2F_Quad");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
static int tolua_GraphicsSprite_media_GraphicsSprite_setTextureRect00(lua_State* tolua_S)
{
 ...
 if (
     !tolua_isusertype(tolua_S,1,"media::GraphicsSprite",0,&tolua_err) ||
     (tolua_isvaluenil(tolua_S,2,&tolua_err) || !tolua_isusertype(tolua_S,2,"const NS_MEDIA::Rect",0,&tolua_err)) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
 else
...
#endif
 {
...
#endif
  {
   const NS_MEDIA::Rect& tolua_ret = (const NS_MEDIA::Rect&)  self->getTextureRect();
    tolua_pushusertype(tolua_S,(void*)&tolua_ret,"const NS_MEDIA::Rect");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
#endif
 {
...
#endif
  {
   const Vec3& tolua_ret = (const Vec3&)  self->getTextColor();
    tolua_pushusertype(tolua_S,(void*)&tolua_ret,"const Vec3");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
#endif
 {
...
#endif
  {
   const NS_MEDIA::Size& tolua_ret = (const NS_MEDIA::Size&)  self->getScissorBox();
    tolua_pushusertype(tolua_S,(void*)&tolua_ret,"const NS_MEDIA::Size");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
